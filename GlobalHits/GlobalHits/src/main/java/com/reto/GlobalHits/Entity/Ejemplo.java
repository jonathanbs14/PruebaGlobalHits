...
@NamedStoredProcedureQueries({
    @NamedStoredProcedureQuery(name = "Ejemplo.sp_ejemplo",
            ...
            parameters = {
                    @StoredProcedureParameter(name = "nombre1", type = String.class, mode = ParameterMode.IN),
                    @StoredProcedureParameter(name = "fec_registro1", type = Date.class, mode = ParameterMode.IN),

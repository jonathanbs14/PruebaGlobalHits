...
CREATE PROCEDURE sp_ejemplo(IN nombre1 VARCHAR(50), IN fec_registro1 DATE, OUT cursor  VARCHAR(50), OUT codigo  VARCHAR(50), OUT mensaje  VARCHAR(50))
BEGIN 
    SELECT cursor,codigo ,mensaje   FROM Ejemplo WHERE fec_registro >= fec_registro1 AND nombre=nombre1;
END